...
function App() {
  ...
  return (
    <div className="App">
      <h1 id="p2" className="font-sans text-5xl font-bold text-yellow-700 hover:scale-110 transition-all duration-300 ease-linear">
        ¡Hola! Soy
      </h1>
      ...
      <div className="p-5 m-5 bg-zinc-900 rounded-lg h-auto min-h-min">
        <h1 className="text-2xl font-Montserrat font-light">Formulario</h1>
